...
select feeds.id, feeds.created_at, feeds.updated_at, feeds.user_id, feeds.name, feeds.url, feeds.last_fetched_at, users.id, users.created_at, users.updated_at, users.name
from feeds 
